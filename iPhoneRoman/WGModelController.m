...
@interface WGModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation WGModelController
...
{   
    ...
    WGDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"WGDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(WGDataViewController *)viewController];
